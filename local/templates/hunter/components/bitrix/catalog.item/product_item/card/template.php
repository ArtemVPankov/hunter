...
-->
    ...
    <div class="img-wrapper">
        <div class="links-wrapper">
            ...
            <a href="<?=$item['DETAIL_PAGE_URL']?>" class="quick-view">Quick view</a>
        </div>
    ...
    <div class="price">
        <span class="new">
            <span class="currency"></span><?=$price['PRINT_RATIO_BASE_PRICE']?>
        </span>
        <span class="old">
            <span class="currency">$</span>600.99
        </span>
    </div>
    ...
    <div class="buttons-block">
        ...
        <a href="" class="btn link one-click">buy in 1-click</a>
    </div>
<!--
